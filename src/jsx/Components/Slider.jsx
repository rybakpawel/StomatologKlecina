        ...
        <Swiper
            ...
            <SwiperSlide>
                <section className='slider'>
                    <h1 className='slider__title'>{slides[0].title}</h1>
                    <p className='slider__description'>{slides[0].description}</p>
            ...
            <SwiperSlide>
                <section className='slider'>
                    <h1 className='slider__title'>{slides[1].title}</h1>
                    <p className='slider__description'>{slides[1].description}</p>
            ...
            <SwiperSlide>
                <section className='slider'>
                    <h1 className='slider__title'>{slides[2].title}</h1>
                    <p className='slider__description'>{slides[2].description}</p>
